...
- Supports +, -, ×, ÷, and decimal point

- Keyboard-friendly (type instead of clicking)

- Clear (C) button to reset

- Cute, themed UI inspired by Bobby Jack aesthetic
...
https://github.com/cruz-ht/Calculator-Challenge.git
